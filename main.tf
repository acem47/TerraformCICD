...
resource "azurerm_resource_group" "moe-tes-grp" {
  name     = "dockerdevops"
  location = "UAE North"
}
...
resource "azurerm_container_group" "tfcg_test" {
  name                = "node-group-moe"
  location            = azurerm_resource_group.moe-tes-grp.location
  resource_group_name = azurerm_resource_group.moe-tes-grp.name
